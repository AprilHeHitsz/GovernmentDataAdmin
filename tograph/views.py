...
def to_graph(categories, nodes, links) -> Graph:
    c = (
        Graph(
            init_opts=opts.InitOpts(width="500px", height="250px")
        )
            .add(
            "",
            nodes=nodes,
            ...
            gravity=0.03,
            repulsion=230,
            linestyle_opts=opts.LineStyleOpts(color="black", curve=0.1),
            label_opts=opts.LabelOpts(is_show=True, position='inside', font_size=13),
            is_draggable=True,
